...
# t6_start
boxplot(esoph$ncontrols, range = 0, main = "Anzahl der Kontrollen", ylab = "ncontrols")
...
# t7_start
output_hist <- hist(airquality$Temp, breaks = 15, xlim = c(50, 100),
                    col = "coral", xlab = "Temperatur  [°F]",
                    main = "Histogramm der Tageshöchstemperaturen am Flughafen La Guardia", freq = FALSE)
# t7_ende
