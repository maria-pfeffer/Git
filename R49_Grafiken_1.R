...
# t1_start
plot(airquality$Temp, airquality$Ozone, pch = 16, col = "#FFA50080",
     xlab = "Temperatur  [°Fahrenheit]", ylab = "Ø Ozon  [ppb]",
     xlim = c(50, 100), main = "Mehr Ozon an warmen Tagen", las = 1,
...
# t3_start
abline(h = mean(airquality$Ozone, na.rm = TRUE), col = "blue", lty = 2)
# t3_ende
...
# t4_start
text(x = 78, y = 115, labels = "30. Mai", pos = 2, adj = 1)
# t4_ende
...
# t5_start
legend("topleft", legend = c(2, 5, 10, 20),
       title = "Windgeschwindigkeit  [mph]",
       col = "orange", pch = 16,
       pt.cex = c(2, 5, 10, 20)/5)
# t5_ende
